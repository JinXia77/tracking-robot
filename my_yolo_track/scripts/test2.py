...
class image_converter:
    ...
    def callback_rgb(self,data):
        ...
        for i in range(len(boxes)):
            if i in indexes:
                ...
                for j in range(0,det_objs_num,1):
                    ...
                    if ((tracking_object_self.track_class == label) and (color_dif_b < self.color_dif_confidance) and (color_dif_g < self.color_dif_confidance) and (color_dif_r < self.color_dif_confidance)):
        ...
        # print("self.det_objs type")
        # print(type(self.det_objs))
