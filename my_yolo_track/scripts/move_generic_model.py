...
import math
import numpy
sys.path.append('/home/project/turtlebot/src/turtle_tf_3d/src/turtle_tf_3d')
...
class Trajectory:
    ...
    def step_trajectory(self, loop=False):
        ...
        try:
            ...
            if loop:
                # The trajectory doesnt have that index therefore we have finished the trajectory and werestart.
                self.current_trajectory_index = 0
                coordinates = self.trajectory[self.current_trajectory_index]
